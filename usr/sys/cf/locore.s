...
#
	...
	set	B1507, 0x14	# Board type = 1507
#
# 68020 vector table
#
...
hfline:
#	cmp.l	&B1507,bdtype	# 2c	F line exception
	short	0x0cb9
	long	B1507
	long	bdtype
	beq.l	fpsp_fline
	bra.w	Fint
hbsun:
#	cmp.l	&B1507,bdtype	# c0	branch on set or unorder condition
	short	0x0cb9
	long	B1507
	long	bdtype
	beq.l	fpsp_bsun
hinex:
#	cmp.l	&B1507,bdtype	# c4	inexact result
	short	0x0cb9
	long	B1507
	long	bdtype
	beq.l	fpsp_inex
hdz:
#	cmp.l	&B1507,bdtype	# c8	divide by zero
	short	0x0cb9
	long	B1507
	long	bdtype
	beq.l	fpsp_dz
hunfl:
#	cmp.l	&B1507,bdtype	# cc	underflow
	short	0x0cb9
	long	B1507
	long	bdtype
	beq.l	fpsp_unfl
hoperr:
#	cmp.l	&B1507,bdtype	# d0	operand error
	short	0x0cb9
	long	B1507
	long	bdtype
	beq.l	fpsp_operr
hovfl:
#	cmp.l	&B1507,bdtype	# d4	overflow
	short	0x0cb9
	long	B1507
	long	bdtype
	beq.l	fpsp_ovfl
hsnan:
#	cmp.l	&B1507,bdtype	# d8	signaling NAN
	short	0x0cb9
	long	B1507
	long	bdtype
	beq.l	fpsp_snan
	bra.b	fpu_int
hunimp:
#	cmp.l	&B1507,bdtype	# dc	Unassigned, Reserved
	short	0x0cb9
	long	B1507
	long	bdtype
	beq.l	fpsp_unsupp
...
clkin0:	add.l	&0x1000000,%d2	# account for rollover
	bra.b	clkin2		# go back to mainline code

# irq2		- low battery  OR  MFP PIT interrupt from 68030

clk030:	mov.l	cpubaddr+ACCTIMER30,newacct  # get value of acct timer
	bra.b	clkin1
irq2:
clkint:
#	cmp.l	&B68020,bdtype
...
clkin1:
	...
	mov.l	%d6,%d2
	sub.l	acctim,%d2	# subtract
	blt.b	clkin0		# if negative, go account for rollover
clkin2:
...
#	cmp.l	&B68020,bdtype
	...
	mov.l	cpubaddr+ACCTIMER,acctim  # store current time as new oldtim
	rte
rte030:	mov.l	cpubaddr+ACCTIMER30,acctim  # store current time as new oldtim
	rte
retrn4:
	add.l	&0x01000000,%d1	# if negative, account for rollover
	bra.b	retrn3
