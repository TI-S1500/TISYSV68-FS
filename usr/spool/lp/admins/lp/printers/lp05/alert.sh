...
export AUDWS; AUDWS='/JDIS/station/st08/P00139/AUDWS'
export AUTHNO; AUTHNO='25991'
export BF; BF='N'
export COBOL; COBOL='/JDIS/PROG/CMN/runcobol'
export COBOL_SUFFIX; COBOL_SUFFIX='.COB'
export COBOL_TAIL; COBOL_TAIL='-k -t 25600 -b 2000 -c /JDIS/PROG/CMN/config.termcap'
...
export GATEWAY; GATEWAY='NO'
export GOBEGBAK; GOBEGBAK='2000'
export HOME; HOME='/JDIS/home/DLR001'
export IPADDR; IPADDR=''
export KILLSCR; KILLSCR='/bin/kill'
export LANG; LANG='USA'
export LINKTIME; LINKTIME='Thu Feb 22 13:01:03 1996'
...
export MSMODE; MSMODE='12'
export OS; OS='TI_UNIX'
export OSLOCKINFO; OSLOCKINFO='Y'
export PATH; PATH=':~/bin:/JDIS/PROG/CMN:/usr/bin:/bin:/etc:/util'
export PLATFILE; PLATFILE='/JDIS/station/st08/P00139/PLATFILE'
export PLATFORM; PLATFORM='TI'
export PMQCALL; PMQCALL='END'
...
export PRT3; PRT3=''
export PRT4; PRT4=''
export PRTDIR; PRTDIR='/JDIS/DATA/POLLRPTS/'
export PRTOK; PRTOK='Y'
export PS1; PS1='# '
export PSCRN; PSCRN='lp01'
export RMRC; RMRC='0'
export RPTLOG; RPTLOG='/JDIS/DATA/COMM/RPTLOG'
export RUNPATH; RUNPATH='/JDIS/PROG/CMN'
export RUN_PROG; RUN_PROG='/JDIS/PROG/'
export SESSION_DIR; SESSION_DIR='P00139'
...
export ST_DIR; ST_DIR='/JDIS/station/st08/P00139/'
