...
#ifdef	SCCSID
static char multivol_h[] = "@(#)multivol.h	1.5 (TI) 92/09/01";
#endif	SCCSID
...
#define GETREQ		8	/* command to have the driver return a count
				   of the number of oustanding requests */
#define STRIPEBIT	0x01	/* flag in anchor that is set if the anchor
				   shows a striped file system */

#define MV_RAWB       0x100000  /* Bit in minor number that indicates raw
				 * multi-volume device */
