...
#ifdef	SCCSID
static char systm_h[] = "@(#)systm.h	1.19 (TI) 91/08/22";
#endif	SCCSID
...
/* LOGGING */
extern dev_t logdev;		/* log device */
/* LOGGING */
...
extern sema_t mir_open;		/* lock on mirror opens		*/
extern sema_t mirbandup;	/* lock on mirror updates	*/
...
struct buf *geteblk();
#ifndef __GNUC__
/* bread is a macro with the gnu compiler in bread.h */
struct buf *bread();
#endif
struct buf *breada();
struct filsys *getfs();
