...
#ifdef	SCCSID
static char kerrf_h[] = "@(#)kerrf.h	1.21 (TI) 91/12/20";
#endif	SCCSID
...
#define SINGLE_PARITY2	(KERN|OS|WARNING|1)
#define DOUBLE_PARITY	(KERN|OS|FATAL)
#define DBL_PARITY	(KERN|OS|FATAL|1)
#define DBL_PARITY2	(KERN|OS|FATAL|3)
...
#define E_LOGSNIF	(KERN|IO|DEVICE|DBG|1)
/* CF */
/* ML */
/* VM */
