...
#ifdef	SCCSID
static char sccsid[] = "@(#)stbm.h	1.71 (TI) 92/10/06 ";
#endif	SCCSID
...
#define STRLNKADDR	0x0107c000l	/* MUST BE PHYSICALLY CONTIGUOUS MEM*/
#define MAXSTRLNK	0x00002000l	/* strnlnk */
#define MINSTRLNK	4		/* minimum, if not zero */
#define DEFSTRLNK	16

/* cblock table:  struct cblock cfree[NCLIST] */
#define CBLOCKADDR	0x0107e000l
#define MAXCBLOCK	0x000b4000l	/* cblock size */
#define MINCBLOCK	70		/* minimum, if not zero */

/* number of dblocks for streams: struct dblk_t dblock[DBLOCK] */
#define DBLOCKADDR      0x01132000l  	
#define MAXDBLOCKSZ	0x00050000l	/* ndblock */

/* available addresses from 0x01182000 to 0x011d2000 */

/* number of mblocks for streams: struct mblk_t mblock[MBLOCK] */
#define MBLOCKADDR	0x011d2000l  
#define MAXMBLOCKSZ	0x00096000l	/* nmblock */

/* 
* msc disk/tape controller structure 
*/
#define MSCADDR		0x01268000l
#define MSCMAX		0x0004d000l

/* 
*  nupi disk/tape controller structure 
*/
#define NPIADDR		0x012b5000l
#define NPIMAX		0x00027000l

/* available addresses from 0x012dc000 to 0x01400000 */

/* process table: struct proc proc[NPROC] */
#define PROCADDR	0x01400000l
#define MAXPROC		0x00121000l	/* procsiz */
#define MINNPROC	50
#define DEFNPROC	100

/* available addresses from 0x01521000 to 0x015a8000 */

/* mmu table: struct mmu_table mmu_table[NPROC] */ 
#define MMUADDR		0x015a8000l	
#define MAXMMUT		0x00023000l	/* mmusiz */

/* sem_undo: struct sem_undo *sem_undo[NPROC] */ 
#define SEMADD		0x015cb000l
#define MAXSEM		0x00005000l	/* semsiz */

/* iseg table: struct iseg iseg[NISEG] */
#define ISEGADDR	0x015d0000l
#define MAXISEG		0x00048000l     /* isegsiz */
#define MINISEG		20
#define DEFISEG		80       

/* segdesc table: struct segdesc segdesc[NSEGDESC] */
#define SEGDESCADDR	0x01618000l
#define MAXSEGDESC	0x00160000l	/* segdescsiz */
#define MINSEGDESC	60
#define DEFSEGDESC	500

/* segdsm table: struct segdsm segdsm[NSEGDSM] */
#define SEGDSMADDR	0x01778000l  
#define MAXSEGDSM	0x00143000l  	/* segdsmsiz */
#define MINSEGDSM	40           
#define DEFSEGDSM	300          

/* open file table: struct file file[NFILE] */
#define FILEADDR	0x018bb000l
#define MAXFILE		0x0004a000l	/* filesiz */
#define MINNFILE	100
#define DEFNFILE	250

/* in memory inode table: struct inode inode[NINODE] */
#define INODEADDR	0x01905000l
#define MAXINODE	0x0011C000l	/* inosiz */
#define MINNINODE	100
#define DEFNINODE	200

/* in memory inode table: struct s5inode s5inode[NINODE] */
#define S5INODEADDR	0x01a21000l
#define MAXS5INODE	0x00156000l	/* s5inosiz */

/* callout table: struct callo callout[NCALL] */
#define CALLADDR	0x01b77000l
#define MAXCALL		0x00006000l	/* calsiz */
#define MINNCALL	10
#define DEFNCALL	50

/* mount table: struct mount mount[NMOUNT] */
#define MOUNTADDR	0x01b7d000l
...
/* mirror buffer header pool */
#define MINMIRBUF	1
#define DEFMIRBUF	1
/* maximum is the number of buffers in the buffer pool */
...
*/
#define KVWADDR		0x01fa0000l  
#define KVWMAX		0x00020000l

/* available addresses from 0x01fc0000 to 0x02000000 */
...
struct stbmsave
{
	...
	char *savrbuf;			/* Ptr to the ROM log message buffer */
	char *savbuf;			/* Ptr to the log message buffer */
};
/********
* 
...
struct stbmdata
{
	...
	int	nmha;		/* number of mha's found on the system*/
	...
	int	nbufval;	/* number of file buffers specified by user*/
	int	totbuf;		/* total number of file buffers */
	int	bufsiz;		/* size of file buffers and buffer headrs */
	int	mirbufcnt;	/* number of mirror buffer headers */
	...
	int	pmaplistsiz;	/* size of pmapinfo array */
	int	shmbrk;		/* shared memory break value in 4k pages*/
	int 	niseg;		/* number of iseg structures*/
	int	isegsiz;	/* size of iseg structures */
	...
	unsigned long rdsiz;	/* user specified size of ram disk (1k bytes)*/
	...
	int	nmtc;		/* number of MTCs per MHA */
	int	nclistsiz;	/* size of clist (cblocks) */
	int	chiptype;	/* type of chip (68020/030/040)		*/
	char	*nvram_addr[MAXSLOTS];  /* nvram physical address       */
	char    cpunum[MAXSLOTS];       /* cpuid for each slot          */
};
...
/* DFBC */
	unsigned long bufcmem;	/* memory for buffer cache blocks (bytes)*/
/* DFBC */
};
/**********
*
...
struct stbmdata2
{
	...
	int 	nsegdesc;	/* number of segdesc structures		*/
	int	segdescsiz;	/* size of segdesc structures		*/
	int 	nsegdsm;	/* number of segdsm structures		*/
	int	segdsmsiz;	/* size of segdsm structures		*/
/* LOGGING */
	unsigned long logslot;  /* slot for log device */
	unsigned long logunit;	/* unit for log device */
	         long logslice; /* slice number for log device */
	unsigned long log_enable; /* Log Enable */
/* LOGGING */
	short	roottype;	/* function type of root device */
	short	swaptype;	/* function type of swap device */
	short	pipetype;	/* function type of pipe device */
        short   logtype;        /* function type of log  device */
	unsigned long rootlog;  /* logical unit number for root device */
	unsigned long swaplog;  /* logical unit number for swap device */
	unsigned long pipelog;  /* logical unit number for pipe device */
        unsigned long loglog;   /* logical unit number for log  device */
};
/********
*
...
/* LOGGING */
#define INITLOG         67      /* cannot initialize log device */
#define LOGPART		68	/* unable to verify log partition*/
#define UNSPTDEVL	69	/* log device selection unsupported*/
/* LOGGING */
#define DATALOST	70	/* data lost in logging buffer */
#define ROMPASS		71	/* ROM passed message */
#define ROMFAIL		72	/* ROM failed message */

#define DATALOSTSIZ	33	/* data lost message size */
/*****
*
...
#define STBM_SEGDESCV	104	
#define STBM_SEGDSMV	105
...
#define STBM_MBUF	201	
#define STBM_MTCV	202	
#define STBM_LANFND	203	
#define STBM_1508FND	204	
#define STBM_040FND	205	
#endif SCCSID    
 ...
 * clicks given
*/
#define ctol3pt(clicks) (((clicks) + NPTESL3PT - 1)/NPTESL3PT)
