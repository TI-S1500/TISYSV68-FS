...
#ifdef	SCCSID
static char proc_h[] = "@(#)proc.h	1.40 (TI) 90/10/12";
#endif	SCCSID
...
#define	p_arg	p_unw.p_int
	...
	struct proc *p_xlink;	/* list of procs sharing text */
	...
	int	p_flagp;	/* Used for polling flag. protected with   */
				/* cookie.  */
	long	p_spare_w_air0;	/* space holder to keep struct same as 3.2.1*/
	long	p_spare_w_air;	/* spare space in proc struct		*/
...
#define SSPADEC 0x200000	/* SPA password decoded	*/
