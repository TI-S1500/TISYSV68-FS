...
#ifdef	SCCSID
static char np_h[] = "@(#)np.h	1.33  (TI) 90/09/13";
...
#define	TOL		0x10000000
#define	WPROT		0x01000000
#define	NTREADY		0x00200000
...
** Nupi tape:
** bit    0:	unit select.
** bits 1-3:	formatter select.
** bit    4:	rewind on close.
** bit    5:	QIC format ( 0 => QIC24, 1 => QIC11 )
**
