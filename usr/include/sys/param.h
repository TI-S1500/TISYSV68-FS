...
#ifdef	SCCSID
static char param_h[] = "@(#)param.h	1.55 (TI) 90/11/16";
#endif	SCCSID
...
#define B68020	0		/* board type=68020 */
#define B68030	0x30		/* board type=68030 */
#define B1505	0x15		/* board type=1505 */
#define B1507	0x14		/* board type=1507 */

#define MFF030  220 		/* Est. percent 030 is faster than 020 */
#define RLSPEED0 120		/* Est. percent cpu 0 is faster than others*/
...
#define DMAPPGS 3		/* number of configurable data L3s 4k pages*/
#define DMAPL3S 43		/* number of L3 tables for configurable data*/
#define	CPULOCSZ  1 		/* size of cpu local area (clicks) */
#define MAXCPU		12	/* max number of cpu's 			*/
...
#define	NSYSENT	75		/* # of system calls */
