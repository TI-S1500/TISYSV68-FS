...
#ifdef	SCCSID
static char partab_h[] = "@(#)partab.h	1.5 (TI) 91/05/17";
#endif	SCCSID
...
{ 
	...
	char	p_comment[48]; 		/* partition comment */
                                        /* Note: 48 chars is maximum size for
                                         * comment on all types of disks. Some
                                         * disks will have smaller comment 
                                         * field (pentrylth determines size) */
};
