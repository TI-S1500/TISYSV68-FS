...
#ifdef	SCCSID
static char psl_h[] = "@(#)psl.h	1.4 (TI) 86/02/04";
#endif	SCCSID

/* @(#)psl.h	2.1	UNIX System V/68 */
/*
 *  	processor status
 */
/*
...
#define	PS_T1	0x8000		/* trace on instruction execution */
#define	PS_T0	0x4000		/* trace on change of flow of control */
#define	PS_IPL	0x700		/* interrupt priority level */
#define	PS_CUR	0x2000		/* current mode. Supervisor if set */
#define	PS_M	0x1000		/* current mode. Master if set */
